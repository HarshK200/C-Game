...
*/
static inline void _log(TextColor text_color, const char* prefix, const char* msg)
{
#ifdef LOG_COLOR_OFF
    printf("%s %s\n", prefix, msg);
#else
...
static inline void _logf(TextColor text_color, const char* prefix, const char* msg, Args... args)
{
